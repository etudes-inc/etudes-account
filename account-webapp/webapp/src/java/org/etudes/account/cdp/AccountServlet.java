/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/account/trunk/account-webapp/webapp/src/java/org/etudes/account/cdp/AccountServlet.java $
 * $Id: AccountServlet.java 5243 2013-06-21 20:28:06Z ggolden $
 ***********************************************************************************
 *
...
{
	/** Our log (commons). */
	private static Log M_log = LogFactory.getLog(AccountServlet.class);
	...
	public void init(ServletConfig config) throws ServletException
	{
		...
		final CdpHandler handler = new AccountCdpHandler();
